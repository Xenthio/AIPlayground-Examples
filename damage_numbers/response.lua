...
-- Server detects damage via EntityTakeDamage, sends position+amount to clients.
-- Client renders 3D2D text floating upward that fades out over ~1.2 seconds.
RunServerLua([==[
...
local LIFETIME = 1.2
local FADE_AT  = 0.7
local FLOAT    = 40  -- units/sec upward
